...
function Select({ className, trigger, triggerIcon, placeholder, options, ...props }: SelectProps) {
  return (
...
export { Select, SelectContent, SelectItem, SelectScrollDownButton, SelectScrollUpButton, SelectSeparator, SelectTrigger };
